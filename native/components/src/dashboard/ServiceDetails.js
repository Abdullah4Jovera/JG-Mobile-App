...
import { StyleSheet, Text, View, ImageBackground, ActivityIndicator, TouchableOpacity, ScrollView } from 'react-native';
...
const ServiceDetails = (props) => {
    ...
    const submitBusinessLoanDocuments = async (fileUrls, token) => {
        try {
            ...
            const response = await fetch(`https://studies-kde-suspension-composer.trycloudflare.com/api/businessfinance-loans/upload-documents/${loanId}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
    ...
    const submitMortgageLoanDocuments = async (fileUrls, token) => {
        try {
            const response = await fetch(`https://studies-kde-suspension-composer.trycloudflare.com/api/mortgage-loans/upload-documents/${loanId}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
    ...
    const submitPersonalLoanDocuments = async (fileUrls, token) => {
        try {
            const response = await fetch(`https://studies-kde-suspension-composer.trycloudflare.com/api/personal-loans/upload-documents/${loanId}`, {
                method: 'PUT',
                headers: {
                    'Content-Type': 'application/json',
                    'Authorization': `Bearer ${token}`,
