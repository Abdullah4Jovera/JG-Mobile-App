...
import { StyleSheet, Text, View, ImageBackground, TextInput, TouchableOpacity,Image, ActivityIndicator, ScrollView} from 'react-native';
...
const PersonalLoanForm = () => {
    ...
    const API_BASE_URL = 'https://outdoors-casinos-achieving-vista.trycloudflare.com/api/personal-loans/apply-for-personal-loan';
