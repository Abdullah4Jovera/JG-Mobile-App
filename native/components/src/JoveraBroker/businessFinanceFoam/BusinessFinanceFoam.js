...
const BusinessFinanceFoam = () => {
    ...
    const API_BASE_URL = 'https://outdoors-casinos-achieving-vista.trycloudflare.com/api/businessfinance-loans/apply-for-business-finance-loan'; // Example base URL
