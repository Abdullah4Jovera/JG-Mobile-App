...
const PriceModelDiamond = () => {
    ...
    const handlePayPalPayment = async () => {
        ...
        setLoading(true);
        try {
            const response = await fetch('http://192.168.2.137:8080/paypal/pay', {
                method: 'POST',
                headers: {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.mainPayView}>
                ...
                <Text style={styles.textPay}>DIAMOND</Text>
                <View style={styles.amountEditor}>
                    <Text style={styles.aedamount}>60AED</Text>
                    <View>
                ...
                <View style={styles.unlimitedView}>
                    ...
                    <Text style={styles.unlimitedText}>30h Fast generations</Text>
                </View>
                ...
                <View style={styles.unlimitedView}>
                    <Image source={require('../../../assets/images/payicon.png')} />
                    <Text style={styles.unlimitedText}>12 concurrent fast jobs</Text>
                </View>
...
export default PriceModelDiamond;
