...
const HelpandSupport = () => {
    ...
    // API Call
  const API_BASE_URL = 'https://outdoors-casinos-achieving-vista.trycloudflare.com/api/helpandsupport/submit-help-and-support'; // Example base URL
    ...
    const helpHandler = async () => {
      try {
        ...
        if(response.ok){
          setSuccessMessage('Success! Received Your Message Thanku')
        }else{
