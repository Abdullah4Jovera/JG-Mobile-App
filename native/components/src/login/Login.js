...
import { StyleSheet, Text, View, Image, Dimensions, TextInput, TouchableOpacity, ActivityIndicator, ScrollView, SafeAreaView } from 'react-native';
...
const Login = (props) => {
  ...
  // API Call
  const API_BASE_URL = 'https://outdoors-casinos-achieving-vista.trycloudflare.com/api/users/login'; // Example base URL
          ...
          <View style={styles.formContainer}>
            ...
            {errorEmailNotVerified && (
              <View style={styles.errorViewMessage}>
                <Text style={styles.userMessage}>{errorEmailNotVerified}</Text>
              </View>
            )}

            {error && (
              <View style={styles.errorViewMessage}>
                <Text style={styles.userMessage}>{error}</Text>
              </View>
            )}
