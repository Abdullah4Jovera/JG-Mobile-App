...
const Login = (props) => {
  ...
  // const validateEmail = (emailOrContact) => {
  //   const emailParts = emailOrContact.split('@');
  //   if (emailParts.length !== 2) {
  //     return false;
  //   }
  //   const localPart = emailParts[0];
  //   const domainPart = emailParts[1];
  //   if (localPart.split('.').length < 3 || !domainPart) {
  //     return false;
  //   }
  //   return true;
  // };
  const LoginHandler = async () => {
    ...
    // if (!validateEmail(emailOrContact)) {
    //   setEmailError('Invalid emailOrContact format');
    //   return;
    // }
