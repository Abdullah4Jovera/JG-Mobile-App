...
const timeout = require('connect-timeout'); // Import connect-timeout
...
app.use(timeout('160s')); // Set timeout to 160 seconds (adjust as necessary)
...
app.use((req, res, next) => {
  req.setTimeout(500000); // Set individual request timeout to 500 seconds
  next();
});
