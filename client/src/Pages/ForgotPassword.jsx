...
import '../../src/Pages/forgotpassword.css'; // Ensure correct path to your CSS file
import "@sl-codeblaster/react-3d-animated-card";
import AnimatedCard from "@sl-codeblaster/react-3d-animated-card";
import Card from "react-animated-3d-card";
import JoveraLogoweb from '../../src/assets/loginImages/JoveraLogoweb.png';
...
const ForgotPassword = () => {
  ...
  const onSubmit = async (data) => {
    try {
      setIsLoading(true);
      const response = await axios.post('https://studies-kde-suspension-composer.trycloudflare.com/api/users/forgot-password', data);
